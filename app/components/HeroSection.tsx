      ...
      >
        ...
        >
          ...
          <motion.div variants={item} className="mb-8">
            <span
              className="inline-flex items-center gap-2 text-[11px] font-medium tracking-[0.28em] uppercase px-4 py-2 rounded-full"
              style={{
                color: "#4B92A7",
          ...
          >
            I bridge the gap between AI efficiency and human empathy to drive
